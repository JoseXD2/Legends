...
function onCreatePost() --precaching of images and stuff
	...
	local SplashOffsetX = -100
	local SplashOffsetY = -100
	local SplashAlpha = 0.5
	
	--fucking arrays wonr work so i did this all manually AAAAAAAAAAAAA
	makeAnimatedLuaSprite('eSplash0', 'hud-elements/PurpSplash', 0, 0)
	makeAnimatedLuaSprite('eSplash1', 'hud-elements/BlueSplash', 0, 0)
	makeAnimatedLuaSprite('eSplash2', 'hud-elements/LimeSplash', 0, 0)
	makeAnimatedLuaSprite('eSplash3', 'hud-elements/RedSplash', 0, 0)
	
	addAnimationByPrefix('eSplash0', 'SplashL', 'SplashEffect', 24, false)
	addAnimationByPrefix('eSplash1', 'SplashD', 'SplashEffect', 24, false)
	addAnimationByPrefix('eSplash2', 'SplashU', 'SplashEffect', 24, false)
	addAnimationByPrefix('eSplash3', 'SplashR', 'SplashEffect', 24, false)
	
	setObjectCamera('eSplash0', 'hud')
	setObjectCamera('eSplash1', 'hud')
	setObjectCamera('eSplash2', 'hud')
	setObjectCamera('eSplash3', 'hud')
	
	setProperty('eSplash0.alpha', SplashAlpha)
	setProperty('eSplash1.alpha', SplashAlpha)
	setProperty('eSplash2.alpha', SplashAlpha)
	setProperty('eSplash3.alpha', SplashAlpha)
	
	setProperty('eSplash0.antialiasing', false)
	setProperty('eSplash1.antialiasing', false)
	setProperty('eSplash2.antialiasing', false)
	setProperty('eSplash3.antialiasing', false)
	
	setProperty('eSplash0.x', defaultOpponentStrumX0+SplashOffsetX)
	setProperty('eSplash1.x', defaultOpponentStrumX1+SplashOffsetX)
	setProperty('eSplash2.x', defaultOpponentStrumX2+SplashOffsetX)
	setProperty('eSplash3.x', defaultOpponentStrumX3+SplashOffsetX)
	
	setProperty('eSplash0.y', defaultOpponentStrumY0+SplashOffsetY)
	setProperty('eSplash1.y', defaultOpponentStrumY1+SplashOffsetY)
	setProperty('eSplash2.y', defaultOpponentStrumY2+SplashOffsetY)
	setProperty('eSplash3.y', defaultOpponentStrumY3+SplashOffsetY)
	
	addLuaSprite('eSplash0', true)
	addLuaSprite('eSplash1', true)
	addLuaSprite('eSplash2', true)
	addLuaSprite('eSplash3', true)
end
