...
function onCreate()
	if dadName == 'mony_glitched' then
		...
		addAnimationByPrefix('animatedicon', 'losing', 'mony_w instancia ', 24, true)
		addAnimationByPrefix('animatedicon', 'winning', 'mony_w instancia ', 24, true)
