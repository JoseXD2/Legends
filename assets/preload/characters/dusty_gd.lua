...
function onCreate()
	if dadName == 'dusty_gd' then
		makeAnimatedLuaSprite('animatedicon', 'icons/dustyanimatedicons', getProperty('iconP2.x'), getProperty('iconP2.y'))
		addAnimationByPrefix('animatedicon', 'normal', 'dustty_n instancia ',24, true)
		addAnimationByPrefix('animatedicon', 'losing', 'dustty_l instancia ', 24, true)
		addAnimationByPrefix('animatedicon', 'winning', 'dustty_w instancia ', 24, true)
